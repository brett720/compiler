...
%type <funcDecl>      function_prototype
%type <funcDecl>      function_prototype_header
...
single_declaration :  type_specifier T_Identifier T_Semicolon    
                  ...
                  |   type_specifier T_Identifier assignment_operator expression   T_Semicolon    
                      {
                        $$ = new VarDecl(new Identifier(@1, $2), $1, $4);
                      }
                  ;
...
function_prototype_header : type_specifier T_Identifier T_LeftParen  
                            {
                              $$ = new FnDecl(new Identifier(@1, $2), $1,  new List<VarDecl *>);
                            }
                          | type_specifier T_Identifier T_LeftParen parameter_declaration_list   
                            {
                              $$ = new FnDecl(new Identifier(@1, $2), $1, $4);
                            }
                          ;
...
parameter_declaration   : type_specifier T_Identifier  
                          {
                            $$ = new VarDecl(new Identifier(@1, $2), $1);
                          }
                        ;
...
function_call_header_no_parameters: function_identifier T_LeftParen T_Void    
                                    { 
...
function_call_header_with_parameters: function_identifier T_LeftParen arg_list    
                                      { 
                                        $$ = new Call(@1, NULL, $1, $3);
                                      }
                                    ;
...
unary_expression: postfix_expression    
                ...
                | T_Plus unary_expression   
                  {
                    $$ = new ArithmeticExpr(new IntConstant(@1, 1),new Operator(@2,"*") ,$2);
                  }
